...
Description: Master ReportLab PDF compiler for Book 2 (Class II English).
             Stitches all 15 chapters (6,750 questions) into a single,
...
OUTPUT_PDF_PATH = os.path.join(BASE_DIR, "Book2_Master_Question_Bank.pdf")

CHAPTER_INFO = [
    {"num": "01", "title": "The Rats Who Ate the Iron Balance", "qs": 450},
    {"num": "02", "title": "Four Brahmins", "qs": 450},
    {"num": "03", "title": "The Turtle and the Swans", "qs": 450},
    {"num": "04", "title": "The Wannabe Chocolate", "qs": 450},
    {"num": "05", "title": "Invention of Potato Chips", "qs": 450},
    {"num": "06", "title": "My Favourite Cartoon", "qs": 450},
    {"num": "07", "title": "Nightingale of India", "qs": 450},
    {"num": "08", "title": "Diwali", "qs": 450},
    {"num": "09", "title": "The Himalayas", "qs": 450},
    {"num": "10", "title": "The Banyan Tree", "qs": 450},
    {"num": "11", "title": "A Little Bird I Am", "qs": 450},
    {"num": "12", "title": "The Cat", "qs": 450},
    {"num": "13", "title": "Habits of the Hippopotamus", "qs": 450},
    {"num": "14", "title": "Family's Day Out", "qs": 450},
    {"num": "15", "title": "Fun in the Rain", "qs": 450},
]
...
class MasterNumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if self._pageNumber > 1:
            ...
            self.drawString(36, 762, "ICSE / CBSE CLASS II ENGLISH -- MASTER QUESTION BANK")
            self.setFont("Helvetica", 8)
            self.setFillColor(colors.HexColor('#6B7280'))
            self.drawRightString(576, 762, "15 Chapters | 6,750 Questions")
...
def build_master_pdf():
    ...
    story.append(Paragraph("ICSE &amp; CBSE CLASS II ENGLISH", custom_styles['CoverSubtitle']))
    ...
    story.append(Paragraph("<b>15 Complete Chapters | 9 Sample Paper Categories | 6,750 Total Questions</b>", custom_styles['CoverMeta']))
    story.append(Paragraph("Aligned with CISCE &amp; CBSE Class II Curriculum &amp; Sample Paper Standards", custom_styles['CoverMeta']))
    story.append(Spacer(1, 140))
    story.append(Paragraph("<b>Includes:</b> Plural Nouns | Articles | Calendar &amp; Days | Action Verbs | Punctuation | Phonics Digraphs | Interrogatives | Present Continuous | Helping Verbs", custom_styles['CoverMeta']))
    ...
    for ch in CHAPTER_INFO:
        toc_data.append([
            ...
            Paragraph("9 Sample Paper Categories", custom_styles['TOCDetail'])
        ])
    ...
    # Chapter Stitching
    files_order = [
        ("1. Plural Nouns & Spelling Rules", "plural_nouns_spelling.md"),
        ("2. Articles (A, An, The)", "articles_grammar.md"),
        ("3. Calendar, Days & Abbreviations", "calendar_days_vocabulary.md"),
        ("4. Action Verbs Identification", "action_verbs_identification.md"),
        ("5. Punctuation Marks & Capitalization", "punctuation_marks.md"),
        ("6. Phonics & Vowel Digraphs", "phonics_vowel_digraphs.md"),
        ("7. Question Words & Interrogatives", "question_words_interrogatives.md"),
        ("8. Present Continuous Tense (-ing)", "present_continuous_ing.md"),
        ("9. Helping Verbs (Is, Am, Are)", "helping_verbs_is_am_are.md")
    ]
    ...
    for ch in CHAPTER_INFO:
        ...
        story.append(Paragraph(f"Total Questions: <b>{ch['qs']}</b> | Standard: <b>ICSE/CBSE Class II English</b>", custom_styles['CoverMeta']))
