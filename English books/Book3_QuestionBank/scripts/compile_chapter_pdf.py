...
def compile_pdf(chapter_num):
    ...
    def add_header_footer(canvas, doc_obj):
        ...
        canvas.drawString(54, 750, f"CLASS III ENGLISH QUESTION BANK — CHAPTER {chapter_num}")
    ...
    story.append(Paragraph("📚 CLASS III ENGLISH QUESTION BANK", title_style))
    story.append(Paragraph(f"CHAPTER {chapter_num} QUESTION BANK (300 QUESTIONS)", subtitle_style))
    story.append(HRFlowable(width="100%", thickness=1.5, color=colors.HexColor('#2563EB'), spaceAfter=15))

    summary_data = [
        [Paragraph("<b>Subject:</b> English", body_style), Paragraph("<b>Class:</b> III", body_style)],
        ...
        [Paragraph("<b>Source:</b> Comprehension Book 3", body_style), Paragraph("<b>Board / Blueprint:</b> ICSE / CBSE Class III English Pattern", body_style)]
    ]
