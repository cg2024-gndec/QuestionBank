...
Description: Master ReportLab PDF compiler for Book 5 (Class V English).
...
OUTPUT_PDF_PATH = os.path.join(BASE_DIR, "Book5_Master_Question_Bank.pdf")

CHAPTER_INFO = [
    {"num": "01", "title": "Sankalp and his Friend", "qs": 300},
    {"num": "02", "title": "The Raven that Wanted to be an Eagle", "qs": 300},
    {"num": "03", "title": "The Tiger and the Persimmon", "qs": 300},
    {"num": "04", "title": "The Invention of Television", "qs": 300},
    {"num": "05", "title": "The Invention of the Computer", "qs": 300},
    {"num": "06", "title": "The Milkman of India: Dr. Verghese Kurien", "qs": 300},
    {"num": "07", "title": "The Iron Man of India: Sardar Vallabhbhai Patel", "qs": 300},
    {"num": "08", "title": "The Missile Man of India: Dr. A. P. J. Abdul Kalam", "qs": 300},
    {"num": "09", "title": "Traditional Dresses from India", "qs": 300},
    {"num": "10", "title": "The Narmada River", "qs": 300},
    {"num": "11", "title": "Island Groups of India", "qs": 300},
    {"num": "12", "title": "The Magic of Books", "qs": 300},
    {"num": "13", "title": "My Dream Adventure", "qs": 300},
    {"num": "14", "title": "The Season's Song", "qs": 300},
...
class MasterNumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if self._pageNumber > 1:
            ...
            self.drawString(36, 762, "ICSE / CBSE CLASS V ENGLISH -- MASTER QUESTION BANK")
...
def build_master_pdf():
    ...
    story.append(Paragraph("ICSE &amp; CBSE CLASS V ENGLISH", custom_styles['CoverSubtitle']))
    ...
    story.append(Paragraph("<b>Includes:</b> Multiple Choice Questions | Fill in the Blanks | True/False | Short Answer | Long Answer | Extract Based Tasks", custom_styles['CoverMeta']))
    ...
    for ch in CHAPTER_INFO:
        toc_data.append([
            ...
            Paragraph("6 Categories (Universal Taxonomy)", custom_styles['TOCDetail'])
        ])

    toc_table = Table(toc_data, colWidths=[50, 220, 70, 200], hAlign='LEFT')
    ...
    files_order = [
        ...
        ("3. True / False Questions", "true_false.md"),
        ("4. Short Answer Questions", "short_answer.md"),
        ("5. Long Answer Questions", "long_answer.md"),
        ("6. Extract / Passage Based Questions", "extract_based.md")
    ]
    ...
    for ch in CHAPTER_INFO:
        ...
        story.append(Paragraph(f"Total Questions: <b>{ch['qs']}</b> | Standard: <b>ICSE/CBSE Class V English</b>", custom_styles['CoverMeta']))
