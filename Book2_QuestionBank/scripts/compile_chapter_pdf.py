...
Description: Advanced ReportLab PDF compiler for Book 2 Question Banks.
             Parses Markdown tags and compiles a beautifully styled PDF
             for each chapter covering all 9 Sample Paper categories.
=============================================================================
"""
...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if self._pageNumber > 1:
            self.drawString(36, 762, "ICSE / CBSE CLASS II ENGLISH -- QUESTION BANK")
            self.setFont("Helvetica", 8)
            self.setFillColor(colors.HexColor('#6B7280'))
            self.drawRightString(576, 762, "9 Exam Categories | 450 Questions")
        ...
        self.drawString(36, 25, "Confidential & Proprietary -- Primary Question Bank Series")
...
def build_pdf(chapter_num):
    ...
    story.append(Paragraph("CBSE &amp; ICSE CLASS II ENGLISH -- 9 SAMPLE PAPER CATEGORIES", custom_styles['DocSubtitle']))
