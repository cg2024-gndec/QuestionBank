...
Description: Automated Windows Media OCR script to extract text and
             exercises from COMPREHENSION BOOK 6 PDF into chapter markdown files.
...
async def run_ocr():
    ...
    for ch in CHAPTER_MAP:
        ...
        full_content += f"**Source**: *My Book of English COMPREHENSION & COMPOSITION 6* (Pages {start_p}-{end_p})\n\n"
        full_content += "---\n\n"
